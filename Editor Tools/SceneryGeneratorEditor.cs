...
namespace TinForge.SceneryGenerator
{
	...
	public class SceneryGeneratorEditor : Editor
	{
		...
		private static bool bingbong = true;
		...
		public override void OnInspectorGUI()
		{
			...
			bingbong = EditorGUILayout.Foldout(bingbong, "Doesgthsfuck");
			if(bingbong)
				EditorGUILayout.PropertyField(terrainProp, new GUIContent("Target Mesh"));


			#region Placement Settings
			GUILayout.Label(new GUIContent("Placement Settings"), EditorStyles.boldLabel);
			...
			//EditorGUILayout.IntSlider(raycastHeightProp, 1, 25, new GUIContent("Raycast Height","Height should be higher than tallest point of terrain mesh"));
			//EditorGUILayout.IntSlider(radiusProp, 1, 100, new GUIContent("Radius"));
			...
			#region Prefab Panel
			GUILayout.Label(new GUIContent("Prefabs Panel"), EditorStyles.boldLabel);
			...
			EditorGUILayout.PropertyField(prefabsProp.GetArrayElementAtIndex(0));
			EditorGUILayout.LabelField(prefabsProp.GetArrayElementAtIndex(0).propertyPath);
			#endregion

			EditorGUILayout.Space();

			#region Random Settings
			GUILayout.Label(new GUIContent("Random Settings"), EditorStyles.boldLabel);
			EditorGUILayout.BeginVertical(EditorStyles.helpBox);
